...
export default {
  ...
  methods: {
    onRefresh() {
      if (this.datainfo.orderStatus == 3) {
        this.$router.push({
          path: "Succeed",
          name: "Succeed",
        });
      } else if (this.datainfo.orderStatus == 4) {
        this.$router.push({
          path: "Cancell",
          name: "Cancell",
        });
      } else if (this.datainfo.orderStatus == 5) {
        this.$router.push({
          path: "Transac",
          name: "Transac",
        });
...
.prompt-box-back-imgse {
  background-image: url(../assets/home/event1.png);
